console.log("### p5.collide v0.7.3 ###"),
  ...
  (p5.prototype.collideLineCircle = function (t, o, e, i, r, l, n) {
    ...
    var y = t - e,
      ...
      f = o + s * (i - o);
    return (
      !!this.collidePointLine(x, f, t, o, e, i) &&
      (this._collideDebug && this.ellipse(x, f, 10, 10),
      (y = x - r),
      (d = f - l),
      this.sqrt(y * y + d * d) <= n / 2)
    );
  }),
    ...
    if (y >= 0 && y <= 1 && d >= 0 && d <= 1) {
      if (this._collideDebug || p)
        var u = t + y * (e - t),
          s = o + y * (i - o);
      return (
        this._collideDebug && this.ellipse(u, s, 10, 10), !p || { x: u, y: s }
      );
    }
    return !!p && { x: !1, y: !1 };
  }),
  ...
  (p5.prototype.collidePointPoly = function (t, o, e) {
    for (var i = !1, r = 0, l = 0; l < e.length; l++) {
      ...
      var n = e[l],
        c = e[r];
      ((n.y >= o && c.y < o) || (n.y < o && c.y >= o)) &&
        t < ((c.x - n.x) * (o - n.y)) / (c.y - n.y) + n.x &&
        (i = !i);
    }
    return i;
  }),
  ...
  (p5.prototype.collidePointTriangle = function (t, o, e, i, r, l, n, c) {
    ...
    return (
      this.abs((e - t) * (l - o) - (r - t) * (i - o)) +
        this.abs((r - t) * (c - o) - (n - t) * (l - o)) +
        this.abs((n - t) * (i - o) - (e - t) * (c - o)) ===
      p
    );
  }),
